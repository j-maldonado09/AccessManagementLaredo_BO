...
namespace AccessManagementLaredo
{
	...
	//                                  Specific Interface.
	// *********************************************************************************************
	public interface IPermitRequestStatusRepository : Interfaces.IRepository<PermitRequestStatus>
	{
	}
	...
	public class PermitRequestStatus
	{
	...
	//                                  Repository Class.
	// *********************************************************************************************
	public class PermitRequestStatusRepository : IPermitRequestStatusRepository
	{
		...
		//                  Constructor.
		// ---------------------------------------------------------------------------------------------
		public PermitRequestStatusRepository(Interfaces.IUnitOfWork unitOfWork)
		{
		...
		//                  Insert a new record.
		// ---------------------------------------------------------------------------------------------
		public int Create(PermitRequestStatus entity)
		{
			ConvertCase(entity);

			_strQuery.Clear();
			_strQuery.Append("INSERT INTO PRMT_RQST_STAT (");
			_strQuery.Append("PRMT_RQST_STAT_NM, ");
			_strQuery.Append("PRMT_RQST_STAT_DSCR");
			_strQuery.Append(") OUTPUT inserted.PRMT_RQST_STAT_ID ");
		...
		{
			_strQuery.Clear();
			_strQuery.Append("DELETE FROM PRMT_RQST_STAT WHERE ");
			_strQuery.Append("PRMT_RQST_STAT_ID = @prm_id");
		...
		//                  Update record.
		// ---------------------------------------------------------------------------------------------
		public void Update(PermitRequestStatus entity, int id)
		{
			ConvertCase(entity);

			_strQuery.Clear();
			_strQuery.Append("UPDATE PRMT_RQST_STAT SET ");
			_strQuery.Append("PRMT_RQST_STAT_NM = @prm_name, ");
			_strQuery.Append("PRMT_RQST_STAT_DSCR = @prm_description ");
		...
		public string Read(int? id = -1)
		{
			...
			_strQuery.Append("PRMT_RQST_STAT_ID AS Id, ");
			_strQuery.Append("PRMT_RQST_STAT_NM AS Name, ");
			_strQuery.Append("PRMT_RQST_STAT_DSCR AS Description ");
			_strQuery.Append("FROM PRMT_RQST_STAT ");
		...
		// ---------------------------------------------------------------------------------------------
		private static void ConvertCase(PermitRequestStatus entity)
		{
