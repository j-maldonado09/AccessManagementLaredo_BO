...
namespace AccessManagementLaredo
{
	...
	//                                  Specific Interface.
	// *********************************************************************************************
	public interface IDistrictRepository : Interfaces.IRepository<District>
	{
	}
	...
	public class DistrictRepository : IDistrictRepository
	{
		...
		//                  Constructor.
		// ---------------------------------------------------------------------------------------------
		public DistrictRepository(Interfaces.IUnitOfWork unitOfWork)
		{
		...
		//                  Insert a new record.
		// ---------------------------------------------------------------------------------------------
		public int Create(District entity)
		{
			ConvertCase(entity);

			_strQuery.Clear();
			_strQuery.Append("INSERT INTO DIST (");
			_strQuery.Append("DIST_NM");
			_strQuery.Append(") OUTPUT inserted.DIST_ID ");
		...
		//                  Update record.
		// ---------------------------------------------------------------------------------------------
		public void Update(District entity, int id)
		{
			ConvertCase(entity);
		...
		public string Read(int? id = -1)
		{
			...
			_strQuery.Append("DIST_ID AS Id, ");
			_strQuery.Append("DIST_NM AS Name ");
			_strQuery.Append("FROM DIST ");
		...
		// ---------------------------------------------------------------------------------------------
		private static void ConvertCase(District entity)
		{
