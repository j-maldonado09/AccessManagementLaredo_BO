...
namespace AccessManagementLaredo
{
	...
	//                                  Specific Interface.
	// *********************************************************************************************
	public interface IPermitRequestTypeRepository : Interfaces.IRepository<PermitRequestType>
	{
	}
	...
	public class PermitRequestType
	{
	...
	//                                  Repository Class.
	// *********************************************************************************************
	public class PermitRequestTypeRepository : IPermitRequestTypeRepository
	{
		...
		//                  Constructor.
		// ---------------------------------------------------------------------------------------------
		public PermitRequestTypeRepository(Interfaces.IUnitOfWork unitOfWork)
		{
		...
		//                  Insert a new record.
		// ---------------------------------------------------------------------------------------------
		public int Create(PermitRequestType entity)
		{
			ConvertCase(entity);

			_strQuery.Clear();
			_strQuery.Append("INSERT INTO PRMT_RQST_TYPE (");
			_strQuery.Append("PRMT_RQST_TYPE_NM, ");
			_strQuery.Append("PRMT_RQST_TYPE_DSCR");
			_strQuery.Append(") OUTPUT inserted.PRMT_RQST_TYPE_ID ");
		...
		{
			_strQuery.Clear();
			_strQuery.Append("DELETE FROM PRMT_RQST_TYPE WHERE ");
			_strQuery.Append("PRMT_RQST_TYPE_ID = @prm_id");
		...
		//                  Update record.
		// ---------------------------------------------------------------------------------------------
		public void Update(PermitRequestType entity, int id)
		{
			ConvertCase(entity);

			_strQuery.Clear();
			_strQuery.Append("UPDATE PRMT_RQST_TYPE SET ");
			_strQuery.Append("PRMT_RQST_TYPE_NM = @prm_name, ");
			_strQuery.Append("PRMT_RQST_TYPE_DSCR = @prm_description ");
		...
		public string Read(int? id = -1)
		{
			...
			_strQuery.Append("PRMT_RQST_TYPE_ID AS Id, ");
			_strQuery.Append("PRMT_RQST_TYPE_NM AS Name, ");
			_strQuery.Append("PRMT_RQST_TYPE_DSCR AS Description ");
			_strQuery.Append("FROM PRMT_RQST_TYPE ");
		...
		// ---------------------------------------------------------------------------------------------
		private static void ConvertCase(PermitRequestType entity)
		{
